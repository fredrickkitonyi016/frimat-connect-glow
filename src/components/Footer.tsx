    ...
    <footer className="relative bg-gradient-to-b from-background to-card border-t border-border">
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                <span className="text-accent">Helping your business grow online.</span>
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-xl font-bold text-foreground mb-6">Stay in Touch</h4>
              <p className="text-muted-foreground mb-4">
                Subscribe to our newsletter for tips and updates on tech.
              </p>
