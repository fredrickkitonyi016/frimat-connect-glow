...
const megaMenuData = {
  services: {
    title: "Services",
    items: [
      { name: "Web Development", href: "/services/web-development", icon: Globe, description: "Custom websites & web apps", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Mobile Apps", href: "/services/mobile-apps", icon: Smartphone, description: "iOS & Android applications", gradient: "from-cyan-500 to-pink-500" },
      { name: "Cloud Services", href: "/services/cloud-services", icon: Cloud, description: "AWS, Azure & cloud infrastructure", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Cybersecurity", href: "/services/cybersecurity", icon: Shield, description: "Protect your digital assets", gradient: "from-emerald-500 to-lime-500" },
      ...
      { name: "E-commerce", href: "/services/ecommerce", icon: ShoppingBag, description: "Online store solutions", gradient: "from-cyan-500 to-lime-500" },
      ...
      { name: "Government Services", href: "/services/government-services", icon: Building2, description: "KRA, HELB, SHA portals", gradient: "from-cyan-500 to-emerald-500" },
      { name: "Custom Development", href: "/services/custom-development", icon: Code, description: "Bespoke software solutions", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Cloud Migration", href: "/services/cloud-migration", icon: Server, description: "Seamless cloud transitions", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Creative & Design", href: "/services/creative-design", icon: Palette, description: "Logo, branding & graphics", gradient: "from-pink-500 to-cyan-500" },
  ...
  solutions: {
    title: "Solutions",
    items: [
      { name: "Healthcare", href: "/solutions/healthcare", icon: HeartPulse, description: "Digital health solutions", gradient: "from-emerald-500 to-pink-500" },
      { name: "Retail & E-commerce", href: "/solutions/retail", icon: ShoppingBag, description: "Modern retail technology", gradient: "from-cyan-500 to-lime-500" },
      ...
      { name: "Manufacturing", href: "/solutions/manufacturing", icon: Factory, description: "Industry 4.0 solutions", gradient: "from-cyan-500 to-cyan-500" },
    ]
  },
  technologies: {
    title: "Technologies",
    items: [
      { name: "Cloud Platforms", href: "/technologies/cloud-platforms", icon: Server, description: "AWS, Azure, Google Cloud", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Development Stack", href: "/technologies/development-stack", icon: Layers, description: "Modern frameworks & tools", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Security Tools", href: "/technologies/security-tools", icon: Lock, description: "Enterprise-grade security", gradient: "from-emerald-500 to-lime-500" },
  ...
  resources: {
    title: "Resources",
    items: [
      { name: "Blog", href: "#blog", icon: BookOpen, description: "Latest tech insights", gradient: "from-pink-500 to-cyan-500" },
      { name: "Whitepapers", href: "/resources/whitepapers", icon: FileText, description: "In-depth research & guides", gradient: "from-cyan-500 to-cyan-500" },
      { name: "Case Studies", href: "#portfolio", icon: FolderOpen, description: "Success stories", gradient: "from-emerald-500 to-teal-500" },
      { name: "FAQs", href: "#faq", icon: HelpCircle, description: "Common questions answered", gradient: "from-cyan-500 to-lime-500" },
    ]
  }
};
